...
const Category = () => {
  ...
  const categoryList = [
    ...
    {
      category: "vocal",
      imageURL: "https://iconcollective.edu/wp-content/uploads/Girl-in-Vocal-Booth-Doing-Best-Vocal-Warm-Ups.jpg"
    },
    {
      category: "House",
    ...
    <>
      {category_search === 1 ? (
        <div id="container">
          ...
          {categorised_music ? (
            categorised_music &&
            categorised_music?.map((i,idx) => <Music music={i} key={idx}/>)
          ) : (
            <Loader />
          )}
          {totalPages && (
