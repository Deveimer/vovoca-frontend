...
import { getCategorisedMusic, resetCategorisedMusic } from '../../actions/musicActions';
    ...
    <>
      {category_search === 1 ? (
        <div id="container">
          ...
          {categorised_music ? categorised_music && categorised_music?.map((i, index) => <Music key={index} music={i} />) : <Loader />}
          {totalPages && (
